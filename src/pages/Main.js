...
function Main_Page() {
  ...
  const [Info_Detail, setInfo_Detail] = useState([]);
  const InfoBlock = async () => {
    const { data } = await Axios.get("https://web-backend-cloud.herokuapp.com/api/info");
    setInfo_Detail(data);
  };
